...
N 1280 -940 1320 -940 {lab=#net2}
N 1280 -900 1320 -900 {lab=#net3}
N 1280 -700 1320 -700 {lab=#net4}
N 1280 -660 1320 -660 {lab=#net5}
N 1280 -1560 1320 -1560 {lab=#net6}
N 1280 -1520 1320 -1520 {lab=#net7}
N 1280 -1320 1320 -1320 {lab=#net8}
N 1280 -1280 1320 -1280 {lab=#net9}
...
op
remzerovec
write third_order_mfb_lp_filter_wo_C_tb_ac_cl.raw
set appendwrite
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/third_order_mfb_lp_filter_wo_C_tb_ac_cl.raw ac"
}
