...
only_toplevel=true 
value="
.include /foss/designs/TinyWhisper/magic/iq_modulator/tt_um_TinyWhisper_pex.spice
.param VDD=1.8
.param Vcm=VDD/2
.param temp=27
.param Cload=10p
...
op
remzerovec
write tt_um_TinyWhisper_pex_tb_ac.raw
set appendwrite
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/tt_um_TinyWhisper_pex_tb_ac.raw ac"
}
...
C {tt_um_TinyWhisper_pex.sym} 1120 -780 0 0 {name=x1}
