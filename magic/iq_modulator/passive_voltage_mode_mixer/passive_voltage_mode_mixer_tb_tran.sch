...
N 600 -1080 680 -1080 {lab=vout_RF}
...
N 680 -1080 800 -1080 {lab=vout_RF}
N 680 -680 800 -680 {lab=vout_RF}
N 800 -880 800 -680 {lab=vout_RF}
N 800 -1080 800 -880 {lab=vout_RF}
N 980 -760 980 -700 {lab=GND}
N 880 -760 880 -700 {lab=GND}
N 880 -880 880 -820 {lab=vout_RF}
N 980 -880 980 -820 {lab=vout_RF}
N 800 -880 880 -880 {lab=vout_RF}
N 980 -920 980 -880 {lab=vout_RF}
N 880 -880 980 -880 {lab=vout_RF}
...
op
remzerovec
write passive_voltage_mode_mixer_tb_tran.raw
set appendwrite
...
C {vdd.sym} 500 -1200 0 0 {name=l5 lab=VDD}
C {devices/gnd.sym} 540 -940 0 0 {name=l36 lab=GND}
C {devices/lab_wire.sym} 360 -940 0 0 {name=l37 sig_type=std_logic lab=LO_I}
C {devices/lab_wire.sym} 360 -900 0 0 {name=l43 sig_type=std_logic lab=LO_IX}
C {devices/lab_pin.sym} 360 -1100 0 0 {name=l44 sig_type=std_logic lab=vinp1_IF}
C {devices/lab_pin.sym} 360 -1060 0 0 {name=l45 sig_type=std_logic lab=vinn1_IF
}
C {vdd.sym} 500 -800 0 0 {name=l46 lab=VDD}
C {devices/gnd.sym} 540 -540 0 0 {name=l47 lab=GND}
C {devices/lab_pin.sym} 360 -700 0 0 {name=l48 sig_type=std_logic lab=vinp2_IF}
C {devices/lab_pin.sym} 360 -660 0 0 {name=l49 sig_type=std_logic lab=vinn2_IF
}
C {devices/lab_wire.sym} 360 -540 0 0 {name=l50 sig_type=std_logic lab=LO_Q}
C {devices/lab_wire.sym} 360 -500 0 0 {name=l51 sig_type=std_logic lab=LO_QX
}
C {devices/lab_wire.sym} 980 -920 3 1 {name=l52 sig_type=std_logic lab=vout_RF}
C {devices/gnd.sym} 980 -700 0 0 {name=l53 lab=GND}
C {devices/capa.sym} 980 -790 0 0 {name=C1
m=1
value=\{Cload\}
footprint=1206
device="ceramic capacitor"}
C {res.sym} 880 -790 0 0 {name=R1
value=\{Rload\}
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 880 -700 0 0 {name=l54 lab=GND}
C {passive_voltage_mode_mixer.sym} 500 -1080 0 0 {name=x1}
C {passive_voltage_mode_mixer.sym} 500 -680 0 0 {name=x2}
